''' Create 3 yellow aliens in a green Fleet of 30 Aliens.'''
...
# Make 3 yellow aliens from 30 green aliens.
for alien in aliens[:3]:
    if alien['color'] == 'green': # Conditional statement to check if the 3 first alien is green.
        alien['color'] = 'yellow'
        alien['speed'] = 'medium'
        alien['points'] = 10
    elif alien['color'] == 'yellow': # Conditional statement to check if the 3 first alien is yellow.
        alien['color'] = 'red'
        alien['speed'] = 'fast'
        alien['points'] = 15
